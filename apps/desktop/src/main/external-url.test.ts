...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("https://statica.ai")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("https://statica.ai");
    expect(shell.openExternal).toHaveBeenCalledWith("https://statica.ai");
  });
