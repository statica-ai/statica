...
import { useImmersiveMode } from "@statica/views/platform";
import { NewWorkspacePage } from "@statica/views/workspace/new-workspace-page";
import { InvitePage } from "@statica/views/invite";
import { useNavigation } from "@statica/views/navigation";
