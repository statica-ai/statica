...
import { Switch } from "@statica/ui/components/ui/switch";
        ...
        <div className="py-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {cliInstalled === null
              ? "Checking…"
              : cliInstalled
                ? "statica CLI is installed and available in PATH."
                : "statica CLI not found. Install it to enable daemon management."}
          </p>
          {cliInstalled === false && (
            <Button
              variant="outline"
              ...
              onClick={() =>
                window.desktopAPI.openExternal(
                  "https://github.com/statica-ai/statica#cli-installation",
                )
              }
            >
              Installation Guide
