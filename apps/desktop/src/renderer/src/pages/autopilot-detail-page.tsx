...
import { AutopilotDetailPage as AutopilotDetail } from "@statica/views/autopilots/components";
import { useWorkspaceId } from "@statica/core/hooks";
import { autopilotDetailOptions } from "@statica/core/autopilots/queries";
