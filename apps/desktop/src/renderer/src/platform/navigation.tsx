...
import { isReservedSlug } from "@statica/core/paths";
import {
  useTabStore,
  resolveRouteIcon,
...
const APP_URL = import.meta.env.VITE_APP_URL || "https://statica.ai";
 ...
 *
 * This is what @statica/views page components read via useNavigation().
 */
