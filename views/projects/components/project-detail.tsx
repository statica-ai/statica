...
import type { Issue, IssueStatus, ProjectStatus, ProjectPriority } from "@statica/core/types";
import { useAuthStore } from "@statica/core/auth";
import { projectDetailOptions } from "@statica/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@statica/core/projects/mutations";
import { pinListOptions } from "@statica/core/pins";
import { useCreatePin, useDeletePin } from "@statica/core/pins";
import { issueListOptions, childIssueProgressOptions } from "@statica/core/issues/queries";
import { useUpdateIssue } from "@statica/core/issues/mutations";
...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER, PROJECT_PRIORITY_CONFIG } from "@statica/core/projects/config";
import { BOARD_STATUSES } from "@statica/core/issues/config";
import { createIssueViewStore } from "@statica/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@statica/core/issues/stores/view-store-context";
...
import {
  ...
  PopoverTrigger,
  PopoverContent,
} from "@statica/ui/components/ui/popover";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@statica/ui/components/ui/tooltip";
import { EmojiPicker } from "@statica/ui/components/common/emoji-picker";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "statica_project_detail_layout",
  });
