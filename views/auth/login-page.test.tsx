...
describe("LoginPage", () => {
  ...
  it("renders email form with 'Sign in to Statica' title", () => {
    render(<LoginPage onSuccess={onSuccess} />);
    expect(
      screen.getByText(/sign in to statica/i),
    ).toBeInTheDocument();
    expect(
  ...
  it("shows cli_confirm step when existing session + cliCallback", async () => {
    localStorage.setItem("statica_token", "existing-jwt");
