...
import { useCurrentWorkspace } from "@statica/core/paths";
import { WorkspaceAvatar } from "../../workspace/workspace-avatar";
import { useQuery } from "@tanstack/react-query";
import { agentListOptions } from "@statica/core/workspace/queries";
import { filterIssues } from "../../issues/utils/filter";
import { BOARD_STATUSES } from "@statica/core/issues/config";
import { ViewStoreProvider } from "@statica/core/issues/stores/view-store-context";
import { useIssueSelectionStore } from "@statica/core/issues/stores/selection-store";
import { BoardView } from "../../issues/components/board-view";
import { ListView } from "../../issues/components/list-view";
import { BatchActionToolbar } from "../../issues/components/batch-action-toolbar";
import { useClearFiltersOnWorkspaceChange } from "@statica/core/issues/stores/view-store";
import { useWorkspaceId } from "@statica/core/hooks";
import { myIssueListOptions, childIssueProgressOptions, type MyIssuesFilter } from "@statica/core/issues/queries";
import { useUpdateIssue, useLoadMoreDoneIssues } from "@statica/core/issues/mutations";
import { myIssuesViewStore } from "@statica/core/issues/stores/my-issues-view-store";
