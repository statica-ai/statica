...
import { Skeleton } from "@statica/ui/components/ui/skeleton";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@statica/ui/components/ui/alert-dialog";
...
} from "@statica/ui/components/ui/dropdown-menu";
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@statica/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@statica/ui/components/ui/sheet";
import { useIsMobile } from "@statica/ui/hooks/use-mobile";
import { ContentEditor, type ContentEditorRef, TitleEditor, useFileDropZone, FileDropOverlay } from "../../editor";
import { FileUploadButton } from "@statica/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@statica/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@statica/ui/components/ui/popover";
import { Checkbox } from "@statica/ui/components/ui/checkbox";
import { Command, CommandDialog, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@statica/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@statica/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import type { UpdateIssueRequest, IssueStatus, IssuePriority, TimelineEntry, Issue } from "@statica/core/types";
import { ALL_STATUSES, STATUS_CONFIG, PRIORITY_ORDER, PRIORITY_CONFIG } from "@statica/core/issues/config";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@statica/core/paths";
import { useActorName } from "@statica/core/workspace/hooks";
import { useWorkspaceId } from "@statica/core/hooks";
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions } from "@statica/core/issues/queries";
import { memberListOptions, agentListOptions } from "@statica/core/workspace/queries";
import { useUpdateIssue, useDeleteIssue } from "@statica/core/issues/mutations";
import { useRecentIssuesStore } from "@statica/core/issues/stores";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@statica/ui/components/common/reaction-bar";
import { useFileUpload } from "@statica/core/hooks/use-file-upload";
import { api } from "@statica/core/api";
import { useModalStore } from "@statica/core/modals";
import { timeAgo } from "@statica/core/utils";
import { cn } from "@statica/ui/lib/utils";
import { pinListOptions } from "@statica/core/pins";
import { useCreatePin, useDeletePin } from "@statica/core/pins";
...
export function IssueDetail({ issueId, onDelete, defaultSidebarOpen = true, layoutId = "statica_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const id = issueId;
  ...
  const handleUpdateField = useCallback(
    (updates: Partial<UpdateIssueRequest>) => {
      ...
      if (
        ...
        localStorage.getItem("statica:backlog-agent-hint-dismissed") !== "true"
      ) {
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <BacklogAgentHintDialog
              ...
              onDismissPermanently={() => {
                localStorage.setItem("statica:backlog-agent-hint-dismissed", "true");
              }}
              onMoveToTodo={() => {
                updateIssueMutation.mutate(
                  { id, status: "todo" },
