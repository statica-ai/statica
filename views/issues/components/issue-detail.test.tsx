...
import type { Issue, TimelineEntry } from "@statica/core/types";
// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @statica/core/hooks.tsx). vi.mock("@statica/core/paths") only intercepts
...
// Mock @statica/core/auth
const mockAuthUser = { id: "user-1", email: "test@test.com", name: "Test User" };
vi.mock("@statica/core/auth", () => ({
...
// Mock @statica/core/workspace/hooks
vi.mock("@statica/core/workspace/hooks", () => ({
  useActorName: () => ({
...
vi.mock("@statica/core/workspace/queries", () => ({
  memberListOptions: () => ({
...
// Mock @statica/core/paths — after the URL-driven workspace refactor,
...
vi.mock("@statica/core/paths", async () => {
  const actual = await vi.importActual<typeof import("@statica/core/paths")>(
    "@statica/core/paths",
  );
  return {
    ...actual,
...
// Mock issue config
vi.mock("@statica/core/issues/config", () => ({
...
vi.mock("@statica/core/issues/stores", () => ({
...
// Mock react-resizable-panels (used by @statica/ui/components/ui/resizable)
